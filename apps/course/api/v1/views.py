...
from .permission import IsOwnerOrReadOnly, IsOwnerForLessonOrReadOnly
from ...models import Course, Lesson
from .serializers import CourseCreateSerializer, CourseGetSerializer, CourseRudSerializer, LessonGetSerializer, \
